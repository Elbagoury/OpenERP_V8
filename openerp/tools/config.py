...
class configmanager(object):
    def __init__(self, fname=None):
        ...
        group.add_option("--addons-path", dest="addons_path", my_default='openerp/addons,openerp/addons-aeroo-1404,openerp/addons-web-8.0,openerp/addons-seawalk-group,openerp/addons-supersonic,openerp/addons-rat-trading,openerp/addons-music-lodge',
