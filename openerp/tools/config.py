...
class configmanager(object):
    def __init__(self, fname=None):
        ...
        group.add_option("--addons-path", dest="addons_path", my_default='openerp/addons,openerp/addons-tgb,openerp/addons-aeroo-1404,openerp/addons-web-8.0,openerp/addons-seawalk-group,openerp/addons-supersonic',
