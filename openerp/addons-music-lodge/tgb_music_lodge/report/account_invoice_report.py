...
class account_invoice_report(osv.osv):
    ...
    def _select(self):
        select_str = """
            SELECT sub.id, sub.date, sub.product_id, sub.partner_id, sub.tgb_type, sub.country_id,
    ...
    def _sub_select(self):
        select_str = """
                SELECT min(ail.id) AS id,
                    ...
                    ail.product_id, ai.partner_id, ai.tgb_type, ai.payment_term, ai.period_id,
                    u2.name AS uom_name,
    ...
    def _group_by(self):
        group_by_str = """
                GROUP BY ail.product_id, ai.date_invoice, ai.id,
                    ai.partner_id, ai.tgb_type, ai.payment_term, ai.period_id, u2.name, u2.id, ai.currency_id, ai.journal_id,
