function saicoms_pos_models(instance, module){ //module is instance.point_of_sale
    console.log('In new models.js');
    var QWeb = instance.web.qweb;
	var _t = instance.web._t;
    var round_di = instance.web.round_decimals;
    var round_pr = instance.web.round_precision
    
    module.PosModel.extend({
        models: [
        {
            model:  'res.users',
            ...
            model:  'res.partner',
            fields: ['name','street','city','state_id','country_id','vat','phone','zip','mobile','email','ean13','write_date','vi_district_id','vi_city_id','customer_type_id','customer_source_id','saicoms_dob','occupation_id'],
            ...
            {
            model:  'saicoms.customer.type',
            fields: ['name'],
            domain: null,
            loaded: function(self,customer_type){ self.customer_type = customer_type; },
        },
            {
            model:  'saicoms.occupation',
            fields: ['name'],
            domain: null,
            loaded: function(self,occupation){ self.occupation = occupation; },
        },

            {
            model:  'saicoms.customer.source',
            fields: ['name'],
            domain: null,
            loaded: function(self,customer_source){ self.customer_source = customer_source; },
        },
            {
            model:  'vi.district',
            fields: ['name'],
            domain: null,
            loaded: function(self,districts){ self.districts = districts; },
        },
            {
            model:  'vi.city',
            fields: ['name'],
            domain: null,
            loaded: function(self,vi_cities){ self.vi_cities = vi_cities; },
        },
            {
            model:  'pos.session',
