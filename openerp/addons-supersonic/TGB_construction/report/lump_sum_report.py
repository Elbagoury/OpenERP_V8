...
class lump_sum_quotation(report_sxw.rml_parse):
    ...
    def get_scope_of_work_line(self, scope_of_work):
        res = []
        if scope_of_work:
            scope_of_work_arr = str(scope_of_work).split('\n')
            return scope_of_work_arr
        return res
